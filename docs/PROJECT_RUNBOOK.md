...
- 前台关键资源当前版本：`shell-page.js?v=20260316-650`、`route-list-page.js?v=20260316-630`、`map.html?v=20260316-647`、`accessibility-high-contrast.css?v=20260316-630`。
...
- 当前壳层导航修复：从路线页、公告页等任意页面点击“首页总览”时，都会正确回到首页，不再误停留在当前页面。
- 当前用户注册：前台注册页已精简为仅填写`账号 + 密码 + 确认密码`；`姓名 / 年龄 / 手机`不再要求，后端会自动用账号补齐默认显示名。
...
- 当前登录页收口：已删除表单区内的“演示账号 / 公共功能无需登录”两块说明卡，登录页默认更聚焦账号密码输入。
- 当前演示用户：`demo_user / demo123`（已在 MySQL 单实例基线中补齐，可直接用于前台登录或后台用户管理展示）
