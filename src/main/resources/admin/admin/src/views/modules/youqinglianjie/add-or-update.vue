<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="链接名称" prop="lianjiemingcheng">
          <el-input v-model="ruleForm.lianjiemingcheng" 
              placeholder="链接名称" clearable  :readonly="ro.lianjiemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="链接名称" prop="lianjiemingcheng">
              <el-input v-model="ruleForm.lianjiemingcheng" 
                placeholder="链接名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='lianjiemingcheng'){
            this.ruleForm.lianjiemingcheng = obj[o];
	    this.ro.lianjiemingcheng = true;
            continue;
          }
          if(o=='lianjie'){
