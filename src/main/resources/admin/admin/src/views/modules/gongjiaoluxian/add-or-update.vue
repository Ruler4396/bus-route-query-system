<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="路线编号" prop="luxianbianhao">
            <el-input v-model="ruleForm.luxianbianhao" 
                placeholder="路线编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.luxianbianhao" label="路线编号" prop="luxianbianhao">
              <el-input v-model="ruleForm.luxianbianhao" 
                placeholder="路线编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="起点站名" prop="qidianzhanming">
          <el-input v-model="ruleForm.qidianzhanming" 
              placeholder="起点站名" clearable  :readonly="ro.qidianzhanming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="起点站名" prop="qidianzhanming">
              <el-input v-model="ruleForm.qidianzhanming" 
                placeholder="起点站名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="终点站名" prop="zhongdianzhanming">
          <el-input v-model="ruleForm.zhongdianzhanming" 
              placeholder="终点站名" clearable  :readonly="ro.zhongdianzhanming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="终点站名" prop="zhongdianzhanming">
              <el-input v-model="ruleForm.zhongdianzhanming" 
                placeholder="终点站名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tujingzhandian" label="途径站点" prop="tujingzhandian">
                    <span>{{ruleForm.tujingzhandian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	fengmian : false,
	jiage : false,
	qidianzhanming : false,
	tujingzhandian : false,
	zhongdianzhanming : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='qidianzhanming'){
            this.ruleForm.qidianzhanming = obj[o];
	    this.ro.qidianzhanming = true;
            continue;
          }
          if(o=='tujingzhandian'){
	    ...
	    this.ro.tujingzhandian = true;
          ...
          if(o=='zhongdianzhanming'){
            this.ruleForm.zhongdianzhanming = obj[o];
	    this.ro.zhongdianzhanming = true;
            continue;
          }
	...
	this.ruleForm.luxianxiangqing = this.ruleForm.luxianxiangqing.replace(reg,'../../../springbootmf383/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
